namespace AsterNET.Manager.Event
{
	...
	public class DialStateEvent : ManagerEvent
	{
		...
		/// </summary>
		public DialStateEvent(ManagerConnection source)
			: base(source)
		{
		}
        ...
        /// <summary>
		/// Get/Set the dest callerid number of the distination channel.
		/// </summary>
		public string DestCallerIDNum
        {
            get { return destCallerIDNum; }
            set { this.destCallerIDNum = value; }
        }

        /// <summary>
		/// Get/Set the channel state of the distination channel.
		/// </summary>
		public string ChannelStateDesc
        {
            get { return channelStateDesc; }
